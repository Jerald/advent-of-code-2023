...
pub fn run_part<I: Clone, T: Display>(func: impl Fn(I) -> anyhow::Result<T>, input: I, day: Day, part: u8) -> anyhow::Result<()> {
...
fn print_result<T: Display>(result: &anyhow::Result<T>, part: &str, duration_str: &str) {
